...
namespace DibClient
{
    public static class DibClient
    {
        ...
        const string DIBVER_FILER_PATH = ".dibver";
        ...
        static DibClient()
        {
            ...
            versionsData = DIBVERHandler.GetVersionsData(DIBVER_FILER_PATH);
        }
        ...
        public static async void UpdateToVersion(string appName, bool force = false)
        {
            try
            {
                string uri = $"https://localhost:5001/api/dibDownload/{appName}";
